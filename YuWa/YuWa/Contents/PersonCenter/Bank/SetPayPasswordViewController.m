...
- (void)setPayPassword{
    ...
    NSDictionary * pragrams = @{@"user_id":@([UserSession instance].uid),@"device_id":[JWTools getUUID],@"token":[UserSession instance].token,@"phone":self.phone,@"user_type":@(1),@"mobile_code":self.phoneCode,@"payment_code":password};
