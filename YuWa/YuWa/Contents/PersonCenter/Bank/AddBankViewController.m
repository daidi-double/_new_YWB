...
- (void)requestPassword{
    ...
    MyLog(@"str =%@",passStr);
    NSDictionary * pragrams = @{@"device_id":[JWTools getUUID],@"user_id":@([UserSession instance].uid),@"token":[UserSession instance].token,@"user_type":@(1),@"payment_code":passStr};
