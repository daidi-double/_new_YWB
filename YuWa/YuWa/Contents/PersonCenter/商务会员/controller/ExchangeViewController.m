...
-(void)getMoneyDatas{
    ...
    NSDictionary*params=@{@"device_id":[JWTools getUUID],@"token":[UserSession instance].token,@"user_id":@([UserSession instance].uid),@"score":self.exchangeGradeTextField.text,@"user_type":@(1)};
