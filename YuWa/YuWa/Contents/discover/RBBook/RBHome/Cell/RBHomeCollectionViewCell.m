...
- (void)requestLike{
    ...
    NSDictionary * pragram = @{@"note_id":self.model.homeID,@"device_id":[JWTools getUUID],@"token":[UserSession instance].token,@"user_id":@([UserSession instance].uid),@"user_type":@(1),@"auser_type":self.model.user.user_type};
